...
public class Example {
    ...
    public void setUp() throws Exception {
        ...
        baseUrl = "http://magento.brainacad.com/";
    ...
    public void testUserRegistration() throws Exception {
        ...
        String randEmail = "test" + System.currentTimeMillis() + "@test.com";
        driver.get(baseUrl + "/english/customer/account/login/");
        ...
        Assert.assertTrue( isElementPresent(By.className("hello")));
    }
